   ...
   <div className="px-8 md:px-16">
      ...
      <div className="mt-3 text-xs flex justify-between items-center text-[#002D74]">
        <p>Already a member?</p>
              <button className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300" onClick={() => { handleLogin()}}>Login</button>
      </div>
    </div>

     <div className="md:block hidden w-2/3 h-2/3">
