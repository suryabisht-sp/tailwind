...
const FAQ = () => {
  return (
    <div>
<div className="bg-pink-100 pt-10">
        ...
        <div className="p-2 bg-pink-100 rounded-xl">
            <div className="flex flex-col md:flex-row">
                <div className="md:w-1/3 p-4 text-sm">
                    ...
                    <div className="mb-2">How to deactivate your account ?</div>
